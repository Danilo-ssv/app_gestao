import 'package:app_gestao/src/modules/clientes/pages/insert_clientes_page.dart';
...
class _ClientesPageState extends State<ClientesPage> {
  late final ClientesState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertClientesPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<ClientesState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<ClientesState>().data;
                        final loading = context.watch<ClientesState>().loading;
            ...
            if (context.watch<ClientesState>().loading == Loading.refresh) ...const [
