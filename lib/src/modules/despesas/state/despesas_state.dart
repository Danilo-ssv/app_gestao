...
class DespesasState extends ChangeNotifier {
  final DespesasServices _services;
  DespesasState(this._services);

  List<DespesasModel> data = [];
  ...
  Future<bool> insert(BuildContext context, InsertDespesasModel modelo) async {
  ...
  Future<InsertDespesasModel?> readById(BuildContext context, String id) async {
