import 'package:app_gestao/src/modules/categorias_produtos/pages/insert_categorias_produtos_page.dart';
...
class CategoriasProdutosPage extends StatefulWidget {
  const CategoriasProdutosPage({super.key});
...
class _CategoriasProdutosPageState extends State<CategoriasProdutosPage> {
  late final CategoriasProdutosState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertCategoriasProdutosPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<CategoriasProdutosState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<CategoriasProdutosState>().data;
                        final loading = context.watch<CategoriasProdutosState>().loading;
            ...
            if (context.watch<CategoriasProdutosState>().loading == Loading.refresh) ...const [
