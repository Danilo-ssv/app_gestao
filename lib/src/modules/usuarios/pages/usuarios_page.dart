import 'package:app_gestao/src/modules/usuarios/pages/insert_usuarios_page.dart';
...
class _UsuariosPageState extends State<UsuariosPage> {
  late final UsuariosState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertUsuariosPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<UsuariosState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<UsuariosState>().data;
                        final loading = context.watch<UsuariosState>().loading;
            ...
            if (context.watch<UsuariosState>().loading == Loading.refresh) ...const [
