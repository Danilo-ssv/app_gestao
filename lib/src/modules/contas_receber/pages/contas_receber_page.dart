import 'package:app_gestao/src/modules/contas_receber/pages/insert_contas_receber_page.dart';
import 'package:app_gestao/src/modules/contas_receber/pages/contas_receber_parcelling_page.dart';
import 'package:app_gestao/src/modules/contas_receber/pages/contas_receber_write_off_page.dart';
...
class _ContasReceberPageState extends State<ContasReceberPage> {
  late final ContasReceberState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertContasReceberPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<ContasReceberState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DropdownMenu(
                                      ...
                                      initialSelection: context.watch<ContasReceberState>().status,
                                      onSelected: (value) {
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<ContasReceberState>().data;
                        final loading = context.watch<ContasReceberState>().loading;
                                              ...
                                              MenuItemButton(
                                                onPressed: () {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => ContasReceberParcellingPage(
                                                        id: item.id,
                                                        onSave: () {
                                                          state.resetOnDispose(resetFilters: false);
                                                          read(loadMore: false);
                                              ...
                                              MenuItemButton(
                                                onPressed: () {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => ContasReceberWriteOffPage(
                                                        id: item.id,
                                                        onSave: () {
                                                          state.resetOnDispose(resetFilters: false);
                                                          read(loadMore: false);
            ...
            if (context.watch<ContasReceberState>().loading == Loading.refresh) ...const [
