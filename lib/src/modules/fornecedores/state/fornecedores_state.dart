...
class FornecedoresState extends ChangeNotifier {
  final FornecedoresServices _services;
  FornecedoresState(this._services);

  List<FornecedoresModel> data = [];
  ...
  Future<bool> insert(BuildContext context, InsertFornecedoresModel modelo) async {
  ...
  Future<InsertFornecedoresModel?> readById(BuildContext context, String id) async {
