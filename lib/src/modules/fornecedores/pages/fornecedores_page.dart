import 'package:app_gestao/src/modules/fornecedores/pages/insert_fornecedores_page.dart';
...
class _FornecedoresPageState extends State<FornecedoresPage> {
  late final FornecedoresState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertFornecedoresPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<FornecedoresState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<FornecedoresState>().data;
                        final loading = context.watch<FornecedoresState>().loading;
            ...
            if (context.watch<FornecedoresState>().loading == Loading.refresh) ...const [
