...
class ContasPagarWriteOffPage extends StatefulWidget {
  final String id;
  final Function onSave;
  const ContasPagarWriteOffPage({super.key, required this.id, required this.onSave});

  @override
  State<ContasPagarWriteOffPage> createState() => _ContasPagarWriteOffPageState();
}

class _ContasPagarWriteOffPageState extends State<ContasPagarWriteOffPage> {
  ...
  void insert() async {
    ...
    final res = await context.read<ContasPagarState>().writeOff(
          context,
          widget.id,
