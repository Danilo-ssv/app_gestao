...
class ContasPagarState extends ChangeNotifier {
  final ContasPagarServices _services;
  ContasPagarState(this._services);

  List<ContasPagarModel> data = [];
  ...
  Future<bool> insert(BuildContext context, InsertContasPagarModel modelo) async {
  ...
  Future<InsertContasPagarModel?> readById(BuildContext context, String id) async {
