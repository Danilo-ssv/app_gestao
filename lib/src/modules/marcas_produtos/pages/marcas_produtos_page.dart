import 'package:app_gestao/src/modules/marcas_produtos/pages/insert_marcas_produtos_page.dart';
...
class MarcasProdutosPage extends StatefulWidget {
  const MarcasProdutosPage({super.key});

  @override
  State<MarcasProdutosPage> createState() => _MarcasProdutosPageState();
}

class _MarcasProdutosPageState extends State<MarcasProdutosPage> {
  late final MarcasProdutosState state;
  ...
  void navigateToInsertPage(String id, {required bool clone}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => InsertMarcasProdutosPage(
          id: id,
          clone: clone,
          onSave: () {
  ...
  void initState() {
    ...
    state = context.read<MarcasProdutosState>();
      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final data = context.watch<MarcasProdutosState>().data;
                        final loading = context.watch<MarcasProdutosState>().loading;
            ...
            if (context.watch<MarcasProdutosState>().loading == Loading.refresh) ...const [
